...
export function comparatorGpt55CommercialExecutionCost(cost = {}) {
  ...
  const value = (
    (inputTokens * GPT55_STANDARD_SHORT_INPUT_USD_PER_1M)
    + (outputTokens * GPT55_STANDARD_SHORT_OUTPUT_USD_PER_1M)
  ) / TOKENS_PER_MILLION;
  return Number(value.toFixed(12));
}

export function formatComparatorGpt55CommercialExecutionCost(value) {
  const number = Number(value);
